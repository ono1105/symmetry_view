...
When an operation has multiple matching elements, `--element-index` selects which element is the animation reference. The viewer displays only that selected element during animation.
